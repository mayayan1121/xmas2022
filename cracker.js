...
let counter = 0
let jokes =[{Q: "What did the English teacher call Santa's helpers?" ,A: "Subordinate Clauses!"}, {Q: "Where would you find a snowman dancing?" ,A: "At a snowball!"},{Q: "What do you call a blind reindeer?" ,A: "No-eye deer."}, {Q: "What do you call an old snowman?" ,A: "Water!"},{Q: "What did the English teacher call Santa's helpers?" ,A: "Subordinate Clauses!"}, {Q: "What do snowmen have for breakfast?" ,A: "Snowflakes!"}, {Q:"What’s every parent’s favorite Christmas Carol?" ,A: "Silent Night~"}]
...
cracker.addEventListener('click', () => {
  if(counter < 0){
    ...
    wishes.textContent = "I hope the holidays bring a chance for you to recharge! Enjoy some xmas joke here~"
